...
use crate::aries::constraint::LinEqReif;
use crate::fzn::Fzn;
...
/// Reified integer linear equality constraint.
///
/// ```flatzinc
/// constraint int_lin_eq_reif([1,-1,3], [x,y,z], 5, r);
/// % r <-> x - y + 3*z = 5
/// ```
#[derive(Clone, Debug)]
...
impl Encode for IntLinEqReif {
    fn encode(
        ...
        Box::new(LinEqReif::new(sum, self.c, r))
    }
}
