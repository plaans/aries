...
use crate::{find_optimal, instance_1_swap_factory, instance_2_swaps, instance_test_1, solve, utils::*};
...
#[test]
fn test_solve_instance_with_1_swap() {
    let instance = instance_1_swap_factory();
    assert_matches!(solve(&instance, 0, 1), Some(_));
}

#[test]
fn test_solve_instance_with_2_swap() {
    let instance = instance_2_swaps();
    assert_matches!(solve(&instance, 1, 1), Some(_));
}