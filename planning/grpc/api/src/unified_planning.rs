...
pub mod timepoint {
    ...
    impl TimepointKind {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::GlobalStart => "GLOBAL_START",
                Self::GlobalEnd => "GLOBAL_END",
                Self::Start => "START",
                Self::End => "END",
            }
        }
...
pub mod metric {
    ...
    impl MetricKind {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::MinimizeActionCosts => "MINIMIZE_ACTION_COSTS",
                Self::MinimizeSequentialPlanLength => "MINIMIZE_SEQUENTIAL_PLAN_LENGTH",
                Self::MinimizeMakespan => "MINIMIZE_MAKESPAN",
                Self::MinimizeExpressionOnFinalState => {
                    "MINIMIZE_EXPRESSION_ON_FINAL_STATE"
                }
                Self::MaximizeExpressionOnFinalState => {
                    "MAXIMIZE_EXPRESSION_ON_FINAL_STATE"
                }
                Self::Oversubscription => "OVERSUBSCRIPTION",
                Self::TemporalOversubscription => "TEMPORAL_OVERSUBSCRIPTION",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
    ...
    impl Mode {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                ...
                Self::SolvedOptimally => "SOLVED_OPTIMALLY",
            }
        }
        /// Creates an enum from field names used in the ProtoBuf definition.
        pub fn from_str_name(value: &str) -> ::core::option::Option<Self> {
...
pub mod plan_generation_result {
    ...
    impl Status {
        ...
        pub fn as_str_name(&self) -> &'static str {
            match self {
                Self::SolvedSatisficing => "SOLVED_SATISFICING",
                Self::SolvedOptimally => "SOLVED_OPTIMALLY",
                Self::UnsolvableProven => "UNSOLVABLE_PROVEN",
                Self::UnsolvableIncompletely => "UNSOLVABLE_INCOMPLETELY",
...
impl ExpressionKind {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            ...
            Self::FluentSymbol => "FLUENT_SYMBOL",
...
impl Feature {
    ...
    pub fn as_str_name(&self) -> &'static str {
        match self {
            Self::ActionBased => "ACTION_BASED",
            Self::Hierarchical => "HIERARCHICAL",
            Self::Scheduling => "SCHEDULING",
            Self::SimpleNumericPlanning => "SIMPLE_NUMERIC_PLANNING",
            Self::GeneralNumericPlanning => "GENERAL_NUMERIC_PLANNING",
            Self::ContinuousTime => "CONTINUOUS_TIME",
            Self::DiscreteTime => "DISCRETE_TIME",
            Self::IntermediateConditionsAndEffects => {
                "INTERMEDIATE_CONDITIONS_AND_EFFECTS"
            }
            Self::ExternalConditionsAndEffects => "EXTERNAL_CONDITIONS_AND_EFFECTS",
            Self::TimedEffects => "TIMED_EFFECTS",
            Self::TimedGoals => "TIMED_GOALS",
            Self::DurationInequalities => "DURATION_INEQUALITIES",
            Self::SelfOverlapping => "SELF_OVERLAPPING",
            Self::StaticFluentsInDurations => "STATIC_FLUENTS_IN_DURATIONS",
            Self::FluentsInDurations => "FLUENTS_IN_DURATIONS",
            Self::RealTypeDurations => "REAL_TYPE_DURATIONS",
            Self::IntTypeDurations => "INT_TYPE_DURATIONS",
            Self::ContinuousNumbers => "CONTINUOUS_NUMBERS",
            Self::DiscreteNumbers => "DISCRETE_NUMBERS",
            Self::BoundedTypes => "BOUNDED_TYPES",
            Self::NegativeConditions => "NEGATIVE_CONDITIONS",
            Self::DisjunctiveConditions => "DISJUNCTIVE_CONDITIONS",
            Self::Equalities => "EQUALITIES",
            Self::ExistentialConditions => "EXISTENTIAL_CONDITIONS",
            Self::UniversalConditions => "UNIVERSAL_CONDITIONS",
            Self::ConditionalEffects => "CONDITIONAL_EFFECTS",
            Self::IncreaseEffects => "INCREASE_EFFECTS",
            Self::DecreaseEffects => "DECREASE_EFFECTS",
            Self::StaticFluentsInBooleanAssignments => {
                "STATIC_FLUENTS_IN_BOOLEAN_ASSIGNMENTS"
            }
            Self::StaticFluentsInNumericAssignments => {
                "STATIC_FLUENTS_IN_NUMERIC_ASSIGNMENTS"
            }
            Self::StaticFluentsInObjectAssignments => {
                "STATIC_FLUENTS_IN_OBJECT_ASSIGNMENTS"
            }
            Self::FluentsInBooleanAssignments => "FLUENTS_IN_BOOLEAN_ASSIGNMENTS",
            Self::FluentsInNumericAssignments => "FLUENTS_IN_NUMERIC_ASSIGNMENTS",
            Self::FluentsInObjectAssignments => "FLUENTS_IN_OBJECT_ASSIGNMENTS",
            Self::ForallEffects => "FORALL_EFFECTS",
            Self::FlatTyping => "FLAT_TYPING",
            Self::HierarchicalTyping => "HIERARCHICAL_TYPING",
            Self::NumericFluents => "NUMERIC_FLUENTS",
            Self::ObjectFluents => "OBJECT_FLUENTS",
            Self::IntFluents => "INT_FLUENTS",
            Self::RealFluents => "REAL_FLUENTS",
            Self::BoolFluentParameters => "BOOL_FLUENT_PARAMETERS",
            Self::BoundedIntFluentParameters => "BOUNDED_INT_FLUENT_PARAMETERS",
            Self::BoolActionParameters => "BOOL_ACTION_PARAMETERS",
            Self::BoundedIntActionParameters => "BOUNDED_INT_ACTION_PARAMETERS",
            Self::UnboundedIntActionParameters => "UNBOUNDED_INT_ACTION_PARAMETERS",
            Self::RealActionParameters => "REAL_ACTION_PARAMETERS",
            Self::ActionsCost => "ACTIONS_COST",
            Self::FinalValue => "FINAL_VALUE",
            Self::Makespan => "MAKESPAN",
            Self::PlanLength => "PLAN_LENGTH",
            Self::Oversubscription => "OVERSUBSCRIPTION",
            Self::TemporalOversubscription => "TEMPORAL_OVERSUBSCRIPTION",
            Self::StaticFluentsInActionsCost => "STATIC_FLUENTS_IN_ACTIONS_COST",
            Self::FluentsInActionsCost => "FLUENTS_IN_ACTIONS_COST",
            Self::RealNumbersInActionsCost => "REAL_NUMBERS_IN_ACTIONS_COST",
            Self::IntNumbersInActionsCost => "INT_NUMBERS_IN_ACTIONS_COST",
            Self::RealNumbersInOversubscription => "REAL_NUMBERS_IN_OVERSUBSCRIPTION",
            Self::IntNumbersInOversubscription => "INT_NUMBERS_IN_OVERSUBSCRIPTION",
            Self::SimulatedEffects => "SIMULATED_EFFECTS",
            Self::TrajectoryConstraints => "TRAJECTORY_CONSTRAINTS",
            Self::StateInvariants => "STATE_INVARIANTS",
            Self::MethodPreconditions => "METHOD_PRECONDITIONS",
            Self::TaskNetworkConstraints => "TASK_NETWORK_CONSTRAINTS",
            Self::InitialTaskNetworkVariables => "INITIAL_TASK_NETWORK_VARIABLES",
            Self::TaskOrderTotal => "TASK_ORDER_TOTAL",
            Self::TaskOrderPartial => "TASK_ORDER_PARTIAL",
...
pub mod unified_planning_server {
    ...
    #[async_trait]
    pub trait UnifiedPlanning: std::marker::Send + std::marker::Sync + 'static {
    ...
    #[derive(Debug)]
    pub struct UnifiedPlanningServer<T> {
        inner: Arc<T>,
    ...
    impl<T> UnifiedPlanningServer<T> {
        pub fn new(inner: T) -> Self {
    ...
    impl<T> Clone for UnifiedPlanningServer<T> {
        fn clone(&self) -> Self {
            let inner = self.inner.clone();
            Self {
                inner,
    ...
    pub const SERVICE_NAME: &str = "UnifiedPlanning";
    impl<T> tonic::server::NamedService for UnifiedPlanningServer<T> {
