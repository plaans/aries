(define (domain roverprob4213-domain)
 ...
 (:action navigate
  ...
  :precondition (and (can_traverse ?x ?y ?z) (available ?x) (in ?x ?y) (visible ?y ?z) (<= 8 (energy ?x)))
 ...
 (:action sample_soil
  ...
  :precondition (and (in ?x ?p) (<= 3 (energy ?x)) (at_soil_sample ?p) (equipped_for_soil_analysis ?x) (store_of ?s ?x) (empty ?s))
  :effect (and (not (empty ?s)) (full ?s) (decrease (energy ?x) 3) (have_soil_analysis ?x ?p) (not (at_soil_sample ?p))))
 (:action sample_rock
  :parameters ( ?x - rover ?s - store ?p - waypoint)
  :precondition (and (in ?x ?p) (<= 5 (energy ?x)) (at_rock_sample ?p) (equipped_for_rock_analysis ?x) (store_of ?s ?x) (empty ?s))
 ...
 (:action calibrate
  ...
  :precondition (and (equipped_for_imaging ?r) (<= 2 (energy ?r)) (calibration_target ?i ?t) (in ?r ?w) (visible_from ?t ?w) (on_board ?i ?r))
  :effect (and (decrease (energy ?r) 2) (calibrated ?i ?r)))
 (:action take_image
  :parameters ( ?r - rover ?p - waypoint ?o - objective ?i - camera ?m - mode)
  :precondition (and (calibrated ?i ?r) (on_board ?i ?r) (equipped_for_imaging ?r) (supports ?i ?m) (visible_from ?o ?p) (in ?r ?p) (<= 1 (energy ?r)))
 ...
 (:action communicate_soil_data
  ...
  :precondition (and (in ?r ?x_1) (at_lander ?l ?y) (have_soil_analysis ?r ?p) (visible ?x_1 ?y) (available ?r) (channel_free ?l) (<= 4 (energy ?r)))
  :effect (and (communicated_soil_data ?p) (available ?r) (decrease (energy ?r) 4)))
 (:action communicate_rock_data
  :parameters ( ?r - rover ?l - lander ?p - waypoint ?x_1 - waypoint ?y - waypoint)
  :precondition (and (in ?r ?x_1) (at_lander ?l ?y) (have_rock_analysis ?r ?p) (<= 4 (energy ?r)) (visible ?x_1 ?y) (available ?r) (channel_free ?l))
 ...
 (:action communicate_image_data
  ...
  :precondition (and (in ?r ?x_1) (at_lander ?l ?y) (have_image ?r ?o ?m) (visible ?x_1 ?y) (available ?r) (channel_free ?l) (<= 6 (energy ?r)))
