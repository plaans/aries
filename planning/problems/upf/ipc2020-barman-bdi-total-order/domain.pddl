(define (domain p_1_2_2-domain)
 ...
 (:method makeandpourcocktail
  ...
  :ordered-subtasks (and
    (_t63 (achievecontainsshakercocktail ?x_2_0 ?x_1_0))
    (_t64 (achievecleanshot ?x_0_1))
    (_t65 (achieveholding ?x_3 ?x_2_0))
    (_t66 (dopourshakertoshot ?x_2_0 ?x_0_1 ?x_1_0))))
 ...
 (:method makecocktail
  ...
  :ordered-subtasks (and
    (_t67 (achievecleanshaker ?x_0))
    (_t68 (achievecontainsshakeringredient ?x_0 ?x_5))
    (_t69 (achievecontainsshakeringredient ?x_0 ?x_2_1))
    (_t70 (achieveholding ?x_4 ?x_0))
    (_t71 (achievehandempty ?x_3))
    (_t72 (shake ?x_1_0 ?x_5 ?x_2_1 ?x_0 ?x_4 ?x_3))))
 ...
 (:method addingredienttoemptyshaker
  ...
  :ordered-subtasks (and
    (_t73 (achievecontainsshotingredient ?x_4_0 ?x_1))
    (_t74 (achieveholding ?x_5_0 ?x_4_0))
    (_t75 (pour_shot_to_clean_shaker ?x_4_0 ?x_1 ?x_0 ?x_5_0 ?x_2_2 ?x_3_0))))
 (:method addingredienttousedshaker
  :parameters ( ?x_0 - shaker ?x_1 - ingredient ?x_2_2 - level ?x_3_0 - level ?x_4_0 - shot ?x_5_0 - hand)
  :task (achievecontainsshakeringredient ?x_0 ?x_1)
  :precondition (and (not (empty ?x_0)) (shakerlevel ?x_0 ?x_2_2) (next ?x_2_2 ?x_3_0))
  :ordered-subtasks (and
    (_t76 (achievecontainsshotingredient ?x_4_0 ?x_1))
    (_t77 (achieveholding ?x_5_0 ?x_4_0))
    (_t78 (pour_shot_to_used_shaker ?x_4_0 ?x_1 ?x_0 ?x_5_0 ?x_2_2 ?x_3_0))))
 ...
 (:method addingredienttoshot
  ...
  :ordered-subtasks (and
    (_t79 (achievecleanshot ?x_0_1))
    (_t80 (achieveholding ?x_4 ?x_0_1))
    (_t81 (achievehandempty ?x_3))
    (_t82 (fill_shot ?x_0_1 ?x_1 ?x_4 ?x_3 ?x_2_3))))
 ...
 (:method cleanfullshot
  ...
  :ordered-subtasks (and
    (_t83 (achieveholding ?x_3 ?x_0_1))
    (_t84 (empty_shot ?x_3 ?x_0_1 ?x_2_4))
    (_t85 (achievehandempty ?x_1_3))
    (_t86 (clean_shot ?x_0_1 ?x_2_4 ?x_3 ?x_1_3))))
 (:method cleanemptyshot
  :parameters ( ?x_0_1 - shot ?x_1_3 - hand ?x_2_4 - beverage ?x_3 - hand)
  :task (achievecleanshot ?x_0_1)
  :precondition (and (empty ?x_0_1) (used ?x_0_1 ?x_2_4) (not (= ?x_3 ?x_1_3)))
  :ordered-subtasks (and
    (_t87 (achieveholding ?x_3 ?x_0_1))
    (_t88 (achievehandempty ?x_1_3))
    (_t89 (clean_shot ?x_0_1 ?x_2_4 ?x_3 ?x_1_3))))
 ...
 (:method cleanemptyshaker
  ...
  :ordered-subtasks (and
    (_t90 (achieveholding ?x_2_5 ?x_0))
    (_t91 (achievehandempty ?x_1_3))
    (_t92 (clean_shaker ?x_0 ?x_2_5 ?x_1_3))))
 (:method cleanfullshaker
  ...
  :ordered-subtasks (and
    (_t93 (achieveholding ?x_4 ?x_0))
    (_t94 (empty_shaker ?x_4 ?x_0 ?x_2 ?x_5_1 ?x_1_4))
    (_t95 (achievehandempty ?x_3))
    (_t96 (clean_shaker ?x_0 ?x_4 ?x_3))))
 ...
 (:method pickup
  ...
  :ordered-subtasks (and
    (_t97 (achievehandempty ?x_0_0))
    (_t98 (achieveontable ?x_1_2))
    (_t99 (grasp ?x_0_0 ?x_1_2))))
 (:method holdingnull
  :parameters ( ?x_0_0 - hand ?x_1_2 - container)
  :task (achieveholding ?x_0_0 ?x_1_2)
 ...
 (:method pour_shaker_to_shot_action
  ...
  :ordered-subtasks (and
    (_t102 (pour_shaker_to_shot ?x_2 ?x_1_1 ?x_4 ?x_0 ?x_3_0 ?x_5_1))))
 (:action clean_shaker
  :parameters ( ?x_0 - shaker ?x_1_3 - hand ?x_2_5 - hand)
