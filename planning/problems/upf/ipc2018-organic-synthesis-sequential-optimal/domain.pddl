(define (domain alkene_p07-domain)
 ...
 (:predicates (bond ?x - chemical_atom ?y - chemical_atom) (doublebond ?x - chemical_atom ?y - chemical_atom) (triplebond ?x - chemical_atom ?y - chemical_atom) (aromaticbond ?x - chemical_atom ?y - chemical_atom))
 ...
 (:action additionofrohacrossvicdisubstitutedalkene
  :parameters ( ?c_1 - carbon ?c_2 - carbon ?h_5 - hydrogen ?o_6 - oxygen ?r1_8 - carbon ?h_4 - hydrogen ?r0_7_0 - carbon ?h_3 - hydrogen ?r2_9 - hc)
  :precondition (and (not (= ?c_1 ?c_2)) (not (= ?r1_8 ?r0_7_0)) (not (= ?h_3 ?h_4)) (bond ?c_1 ?h_3) (bond ?c_2 ?h_4) (bond ?c_2 ?r1_8) (doublebond ?c_1 ?c_2) (bond ?r0_7_0 ?c_1) (bond ?o_6 ?h_5) (bond ?r2_9 ?o_6))
  :effect (and (not (doublebond ?c_1 ?c_2)) (not (doublebond ?c_2 ?c_1)) (bond ?c_1 ?c_2) (bond ?c_2 ?c_1) (bond ?c_1 ?o_6) (bond ?o_6 ?c_1) (bond ?c_2 ?h_5) (bond ?h_5 ?c_2) (not (bond ?o_6 ?h_5)) (not (bond ?h_5 ?o_6))))
 ...
 (:action hydroborationofdiortrisubstitutedalkene
  :parameters ( ?c_1 - carbon ?h_4 - hydrogen ?c_2 - carbon ?b_5 - boron ?r0_6 - carbon ?r1_7 - carbon ?h_3 - hydrogen ?r2_8_0 - hc ?r3_9 - hc ?r3_10 - hc)
  :precondition (and (not (= ?c_1 ?c_2)) (not (= ?r1_7 ?r0_6)) (not (= ?c_2 ?c_1)) (bond ?c_2 ?h_3) (bond ?c_1 ?r2_8_0) (bond ?c_2 ?r1_7) (doublebond ?c_1 ?c_2) (bond ?r0_6 ?c_1) (not (= ?r3_10 ?r3_9)) (bond ?b_5 ?r3_10) (bond ?b_5 ?h_4) (bond ?r3_9 ?b_5))
 ...
 (:action sulfonylationofalcohol
  :parameters ( ?h_2 - hydrogen ?o_1 - oxygen ?s_5 - sulfur ?cl_3 - chlorine ?r0_7_0 - carbon ?o_4 - oxygen ?r1_8 - carbon ?o_6 - oxygen)
  :precondition (and (bond ?r0_7_0 ?o_1) (bond ?o_1 ?h_2) (not (= ?o_6 ?o_4)) (doublebond ?s_5 ?o_6) (doublebond ?s_5 ?o_4) (bond ?s_5 ?r1_8) (bond ?cl_3 ?s_5))
