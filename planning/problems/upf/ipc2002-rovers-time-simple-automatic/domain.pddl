(define (domain roverprob1234-domain)
 ...
 (:durative-action navigate
  ...
  :duration (= ?duration 5)
  :condition (and (over all (can_traverse ?x ?y ?z))(over all (visible ?y ?z))(at start (available ?x))(at start (at_ ?x ?y)))
  :effect (and (at start (not (at_ ?x ?y))) (at end (at_ ?x ?z))))
 (:durative-action sample_soil
  :parameters ( ?x - rover ?s - store ?p - waypoint)
  :duration (= ?duration 10)
  :condition (and (over all (at_ ?x ?p))(at start (at_ ?x ?p))(at start (at_soil_sample ?p))(at start (equipped_for_soil_analysis ?x))(at start (store_of ?s ?x))(at start (empty ?s)))
 ...
 (:durative-action sample_rock
  :parameters ( ?x - rover ?s - store ?p - waypoint)
  :duration (= ?duration 8)
  :condition (and (over all (at_ ?x ?p))(at start (at_ ?x ?p))(at start (at_rock_sample ?p))(at start (equipped_for_rock_analysis ?x))(at start (store_of ?s ?x))(at start (empty ?s)))
 ...
 (:durative-action calibrate
  ...
  :duration (= ?duration 5)
  :condition (and (at start (equipped_for_imaging ?r))(at start (calibration_target ?i ?t))(at start (visible_from ?t ?w))(at start (on_board ?i ?r))(over all (at_ ?r ?w)))
  :effect (and (at end (calibrated ?i ?r))))
 (:durative-action take_image
  :parameters ( ?r - rover ?p - waypoint ?o - objective ?i - camera ?m - mode)
  :duration (= ?duration 7)
  :condition (and (over all (calibrated ?i ?r))(over all (equipped_for_imaging ?r))(over all (supports ?i ?m))(over all (visible_from ?o ?p))(over all (at_ ?r ?p))(at start (on_board ?i ?r)))
 ...
 (:durative-action communicate_soil_data
  ...
  :duration (= ?duration 10)
  :condition (and (over all (at_ ?r ?x_1))(over all (at_lander ?l ?y))(at start (have_soil_analysis ?r ?p))(at start (visible ?x_1 ?y))(at start (available ?r))(at start (channel_free ?l)))
 ...
 (:durative-action communicate_rock_data
  :parameters ( ?r - rover ?l - lander ?p - waypoint ?x_1 - waypoint ?y - waypoint)
  :duration (= ?duration 10)
  :condition (and (over all (at_ ?r ?x_1))(over all (at_lander ?l ?y))(at start (have_rock_analysis ?r ?p))(at start (visible ?x_1 ?y))(at start (available ?r))(at start (channel_free ?l)))
 ...
 (:durative-action communicate_image_data
  ...
  :condition (and (over all (at_ ?r ?x_1))(over all (at_lander ?l ?y))(at start (have_image ?r ?o ?m))(at start (visible ?x_1 ?y))(at start (available ?r))(at start (channel_free ?l)))
