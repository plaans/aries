...
pub fn max_delay<W: Time>(from: Timepoint, to: Timepoint, max_delay: W) -> Edge<W> {
...
pub fn min_delay<W: Time>(from: Timepoint, to: Timepoint, min_delay: W) -> Edge<W> {
...
///  - edge: first <--- 0 ---- second
pub fn before_eq<W: Time>(first: Timepoint, second: Timepoint) -> Edge<W> {
...
pub fn strictly_before<W: Time>(first: Timepoint, second: Timepoint) -> Edge<W> {
